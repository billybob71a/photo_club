...
?>	
<header>
	<h1 class="entry-title"><?php esc_html_e( 'Nothing Found', 'multipurpose-blog' ); ?></h1>
</header>
...
<?php elseif ( is_search() ) : ?>
	<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'multipurpose-blog' ); ?></p><br />
		<?php get_search_form(); ?>
<?php else : ?>
